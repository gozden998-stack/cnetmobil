...
// app/admin/wingsm-score-rules/page.tsx
//
...
// sadece /api/wingsm/score-rules (bu görevde eklenen CRUD) ile konuşur.
...
export default function WingsmScoreRulesPage() {
  ...
  if (authLoading) {
    return (
      <div className="min-h-screen bg-slate-100 flex items-center justify-center">
        <div className="text-sm font-bold text-slate-500">Yükleniyor...</div>
      </div>
    );
  }
      ...
      <header className="bg-[#2d3035] text-white shadow-sm">
        <div className="max-w-[1450px] mx-auto min-h-[70px] px-5 lg:px-8 flex items-center justify-between gap-4">
          <div>
            ...
            <div className="text-[11px] text-slate-300">WingSM Değer Puan Kuralları</div>
          </div>
