...
export default function IkasStock() {
  const [
    priceTarget,
    setPriceTarget,
  ] = useState<
                      ...
                      {isOpen && (
                        <div className="mt-4 overflow-x-auto rounded-2xl border border-slate-200">
                          ...
                          <div className="grid grid-cols-[minmax(180px,1.3fr)_80px_135px_135px_minmax(120px,1fr)_390px] gap-3 border-b border-slate-200 bg-slate-50 px-4 py-2.5 text-[7px] font-black uppercase tracking-wide text-slate-400">
                            <div>Varyant</div>
                            <div>Stok</div>
                            <div>İkas Liste Fiyatı</div>
                            <div>İkas Satış Fiyatı</div>
                            <div>Lokasyon</div>
                            <div>Stok / Fiyat İşlemi</div>
                          </div>
                            ...
                            (
                              ...
                              return (
                                <div
                                  ...
                                  className="grid grid-cols-[minmax(180px,1.3fr)_80px_135px_135px_minmax(120px,1fr)_390px] items-center gap-3 border-b border-slate-100 px-4 py-3 text-[9px] last:border-0"
                                >
                                  <div>
                                  ...
                                  <div className="flex items-center gap-1.5">
                                    ...
                                    <button
                                      ...
                                      className="h-8 rounded-lg border border-violet-200 bg-violet-50 px-3 text-[8px] font-black text-violet-700 transition hover:bg-violet-100 disabled:opacity-50"
                                    >
                                      Fiyat
                                    </button>
                                  </div>
            ...
            <div className="flex items-start justify-between border-b border-slate-200 px-6 py-5">
              <div>
                ...
                <div className="mt-1 text-[8px] font-bold text-slate-500">
                  {priceTarget.productName} · {priceTarget.variantName}
                </div>
              </div>
