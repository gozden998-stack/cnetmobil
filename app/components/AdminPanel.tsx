                          ...
                          <div className="flex flex-col items-start gap-2">
                            ...
                            {ekspertizData && (
                              <button 
                                ...
                                className="text-[10px] font-black text-blue-400 bg-blue-500/10 hover:bg-blue-50 hover:text-white px-3 py-1.5 rounded-lg transition-all border border-blue-500/20 flex items-center gap-2 group/btn"
                              >
