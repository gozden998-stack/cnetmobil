      ...
      <nav className="bg-white/80 backdrop-blur-md sticky top-0 z-50 border-b border-slate-100">
        <div className="max-w-6xl mx-auto px-6 h-20 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-6 text-sm font-semibold text-slate-500">
            ...
            {/* Destek Alanı ve Sadece WhatsApp Logosu */}
            <div className="flex items-center gap-2 bg-indigo-50/50 p-1 rounded-full border border-indigo-100 shadow-sm pr-1">
              <span className="text-indigo-600 px-4 py-1 text-xs font-bold whitespace-nowrap">0542 342 3759</span>
              <a 
                href="https://wa.me/905423423759" 
                target="_blank" 
                rel="noopener noreferrer"
                className="bg-[#25D366] hover:bg-[#1ebd5b] w-10 h-10 rounded-full flex items-center justify-center transition-all hover:scale-110 shadow-md shadow-green-100"
              >
          ...
          {step === 5 && (
            <div className="text-center max-w-2xl mx-auto animate-in zoom-in-95 duration-700">
               ...
               <button onClick={submitLead} className="w-full py-6 bg-[#25D366] hover:bg-[#1ebd5b] text-white rounded-[24px] font-black text-xl shadow-xl shadow-green-100 transition-all flex items-center justify-center gap-3">
                  {/* Bu ana butonun içindeki logoyu da istersen güncelleyebiliriz */}
