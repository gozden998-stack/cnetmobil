      ...
      <nav className="bg-white sticky top-0 z-50 border-b border-slate-100 shadow-sm">
        <div className="max-w-[1200px] mx-auto px-4 h-20 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            <a href={`https://wa.me/${VATSAP_NUMARASI}`} target="_blank" rel="noopener noreferrer" className="hidden xl:flex items-center gap-2 text-slate-800 font-bold hover:text-[#25D366] transition-colors">
            ...
            <a
              href="/cihaz-sat/iphone-18-on-siparis"
              className="group inline-flex items-center gap-2 rounded-lg border border-blue-200 bg-gradient-to-r from-blue-50 to-indigo-50 px-4 py-2.5 text-sm font-bold text-blue-700 shadow-sm transition-all hover:-translate-y-0.5 hover:border-blue-300 hover:shadow-md"
            >
              ...
              <span className="hidden sm:inline">iPhone 18 Ön Sipariş</span>
              <span className="sm:hidden">iPhone 18</span>
