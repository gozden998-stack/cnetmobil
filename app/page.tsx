...
import MagazaStokTalep from './components/screens/MagazaStokTalep';
...
export default function CnetmobilCmrFinalUltimate() {
  ...
  const [appMode, setAppMode] = useState<'ana_sayfa' | 'alim' | 'servis' | 'cep_tablet' | 'yna_list' | 'dis_kanal' | 'ikinci_el_apple' | 'ikinci_el_android' | 'imei_list' | 'kampanya_sifir' | 'thh' | 'cihaz_talep' | 'magaza_stok_talep'>('ana_sayfa');
  ...
  const menuGroups = [
    ...
    },
    {
      ...
      items: [
        ...
        { id: 'magaza_stok_talep', label: 'Cihaz Talep', visible: selectedBranch !== 'VODAFONE KANALI' && !isZumay },
      ...
      <div className="flex-1 w-full min-w-0 flex flex-col relative">
        <main
          className={`mx-auto w-full print:hidden ${
            (appMode === 'cihaz_talep' || appMode === 'magaza_stok_talep') && step < 99
        ...
        >
          ...
          appMode === 'magaza_stok_talep' && step < 99 ? (
            <MagazaStokTalep />
          ) :
